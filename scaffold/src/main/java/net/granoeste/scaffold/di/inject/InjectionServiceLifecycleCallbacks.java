...
public class InjectionServiceLifecycleCallbacks extends
	...
	private static final String TAG = InjectionServiceLifecycleCallbacks.class.getSimpleName();

	/** GuiceのInjectorオブジェクト */
	private final Injector mInjector;

	public InjectionServiceLifecycleCallbacks(Injector injector) {
		mInjector = injector;
	}

	@Override
	public void onServiceAttachBaseContext(Service service, Context newBase) {
	}

	@Override
	public void onServiceCreated(Service service) {
		mInjector.injectMembers(service);
	}
