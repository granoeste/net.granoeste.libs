...
public abstract class LifecycleCallbacksSupportAppCompatActivity extends AppCompatActivity {
    ...
    private static void dispatchSavedInstanceState(
            LifecycleCallbacksSupportApplication application,
            Activity activity,
            Bundle outState) {
        if (application == null) {
            return;
